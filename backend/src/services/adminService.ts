...
import type { AdminGetUserByIdResponse } from "../interfaces/adminGetUserById";
import { toAdminGetUserByIdResponse } from "../interfaces/adminGetUserById";
...
export class AdminUserService {
  ...
  static async getUserById(
    ...
    return toAdminGetUserByIdResponse(user);
  }
}
